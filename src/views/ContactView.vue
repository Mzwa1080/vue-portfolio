...
<div class="container animate__animated animate__backInRight">
  ...
  <div class="col">
      ...
      <p>
        <a href="mailto:mshawnlouw@gmail.com" style="text-decoration: none">
      ...
      <div class="col">
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" color="gold" fill="currentColor" class=" bi bi-envelope-at" viewBox="0 0 16 16">
          <path
      ...
      <div class="col">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" color="gold" fill="currentColor" class=" bi bi-geo-alt" viewBox="0 0 16 16">
